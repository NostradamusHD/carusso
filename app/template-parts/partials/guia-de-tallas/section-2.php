<section class="section"><!-- start//Section 2 -->
    <div class="grid-container">

        <h3 style="margin-bottom: 3rem; text-transform: uppercase; text-align: center;">Sigue estos cinco pasos, para saber cuánto calzas</h3>
